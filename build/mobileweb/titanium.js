...
var require = {
	app: {
		analytics: true,
		copyright: "2013 Push.ec",
		deployType: "development",
		description: "not specified",
		guid: "0ed518d9-ca6a-42f6-8ffe-1edb7ac37e03",
		id: "ec.push.multicines",
		name: "Multicines",
		names: {},
		publisher: "Push Apps & Desarrollo Interactivo",
		url: "http://push.ec",
		version: "1.2.8"
	},
	has: {
...
require("Ti/App/Properties", function(p) {
	p.setString("acs-oauth-secret-production","9PkudTYKzUuQQFabwkjXESIPzmPASkSE");
	p.setString("acs-oauth-key-production","pSM8zxYzLi2WA3rGAoB5zL8bvnmMJecD");
	p.setString("acs-api-key-production","OyXte9dUv1Ht2pCv13GGxxswnkLuXNq8");
	p.setString("acs-oauth-secret-development","9qsapKLo2v4iKKAsQF5lDrR5DaA8lBLj");
	p.setString("acs-oauth-key-development","0PKlbj8nIKJxsZSX0uAAlOowPuchYLKR");
	p.setString("acs-api-key-development","6IagzEUne6xaRYRSFYyllhjp2vNMeVkw");
